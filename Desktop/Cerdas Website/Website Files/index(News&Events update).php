...
<html lang="en">
	...
	//below is the code for the header section
		<div class="section1">
			<div class="container">
				<div id="header">
					<div class="row">
		...
		//the section with Donate Now button
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-5 col-md-5">
							...
							//contains the paypal link for online donations
							<a class="link-line-blue" href="https://www.paypal.com/donate/?token=22_w_VwHXrAqeBsuZGykpDxgp1-qqbct00VmeRxYxeeo5_coM3x8VXg7tWHPXZdITXz0E0&country.x=US&locale.x=US">Donate Now</a></div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4">
							<div class="paddinginsidebox">
								...
								<div class="desc">Donate: Make a tax-deductible donation (online or mail) or become our monthly pledge partner. <br />
		...
		//Work on updating information for News & Events below
		<div class="section5">
			<div class="container">	
