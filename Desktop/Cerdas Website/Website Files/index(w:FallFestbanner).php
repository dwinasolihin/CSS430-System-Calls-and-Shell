<?php
	...
	if($sessionbrowser == "" || $sessionbrowser == "NULL"){
		...
		echo"<meta http-equiv='Refresh' content='0.000000000000000000000000000000000000000000000001;url=FallFest2017.php'>";
		exit;
	}
...
<html lang="en">
    ...
    <body>
		...
		<div style="position:fixed;width:100%;bottom:0px;z-index:999;">
			<div align="center">
				<div style="border-top:0px solid #ffffff;height:60px;background:#000000;padding:10px 0px;">
					<a href="FallFest2017.php" style="text-decoration:none;">
						<div style="width:950px;color:#ffffff;text-align:left;overflow:auto;">
							<div style="position:absolute;margin-top:-48px;"><img src="assets/img/ff2017thumb.jpg" style="border:3px solid #ffffff;width:120px;"></div>
							<div style="padding-left:140px;">
								<div style="font-weight:bold;font-size:15px;">Upcoming Event! CERDAS Fall Fest 2017</div>
								<div style="font-size:13px;"> It is our pleasure to invite you to join us at Saturday, Dec 16th 2017. Details of the event? Click here!</div>
							</div>
						</div>
					</a>
				</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-5 col-md-5">
							...
							<br/>
							<br/>
							<a class="link-line-blue" href="donate.php">Donate Now</a></div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4">
							<div class="paddinginsidebox">
								...
								<div class="desc">CERDAS is a community powered, volunteer base organization; established in Seattle, Washington</div>						
							</div>
						</div>
						<div class="col-lg-4 col-md-4">
							<div class="paddinginsidebox">
								...
								<div class="desc">We provide Indonesian children access to education through a scholarship program. We also offer relief assistance in the event of a natural disaster or natural emergency in Indonesia.</div>						
							</div>
						</div>	
						<div class="col-lg-4 col-md-4">
							<div class="paddinginsidebox">
								...
								<div class="desc">Donate: Make a tax-deductible donation online or by mail or become our monthly pledge partner Volunteer: CERDAS is always in need of dedicated individuals to help with our fundraising activities and outreach efforts.</div>						
							</div>
						</div>						
					</div>			
				</div>
